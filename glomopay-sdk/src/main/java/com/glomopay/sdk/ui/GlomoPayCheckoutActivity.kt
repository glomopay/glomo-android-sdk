...
import com.glomopay.sdk.GlomoPayApiClient
import com.glomopay.sdk.GlomoPayConfig
import com.glomopay.sdk.GlomoPayResult
import com.glomopay.sdk.CheckoutSessionRegistry
import com.glomopay.sdk.SdkError
import com.glomopay.sdk.SdkErrorType
import com.glomopay.sdk.bridge.GlomoPayEventRouter
import com.glomopay.sdk.bridge.GlomoPayInjectionScripts
import com.glomopay.sdk.bridge.GlomoPayJavaScriptBridge
import com.glomopay.sdk.analytics.GlomoPayLogger
import com.glomopay.sdk.Validator
...
import com.glomopay.sdk.security.CompliancePolicy
import com.glomopay.sdk.security.DeviceComplianceChecker
import com.glomopay.sdk.state.CheckoutUiState
import com.glomopay.sdk.webview.CheckoutWebViewClient
import com.glomopay.sdk.webview.CheckoutWebViewFactory
...
public class GlomoPayCheckoutActivity : Activity() {
    ...
    private var listener: com.glomopay.sdk.GlomoPayListener? = null
    ...
    private var flowProgressBar: ProgressBar? = null
    ...
    private fun buildContentView() {
        ...
        progressBar.max = 100
        val progressParams = FrameLayout.LayoutParams(-1, dp(3), Gravity.TOP)
        ...
        webView.webChromeClient = object : android.webkit.WebChromeClient() {
            override fun onProgressChanged(view: android.webkit.WebView?, newProgress: Int) {
                ...
                if (newProgress > 0) loadingLabel.text = "Loading checkout... $newProgress%"
            }
    ...
    private fun handleConnectionError(error: ConnectionError) {
        ...
        listener?.onSdkError(listOf(com.glomopay.sdk.SdkError(
            com.glomopay.sdk.SdkErrorType.NETWORK_ERROR,
    ...
    private fun cancelCheckout() {
        listener?.onPaymentTerminate(com.glomopay.sdk.TerminationSource.USER_DISMISS)
    ...
    private fun showFlow(url: String) {
        ...
        toolbar.addView(back, LinearLayout.LayoutParams(-2, dp(48)))
        layout.addView(toolbar, LinearLayout.LayoutParams(-1, dp(48)))

        val content = FrameLayout(this)
        val flow = CheckoutWebViewFactory.create(this, config.devMode)
        val flowProgress = ProgressBar(this, null, android.R.attr.progressBarStyleHorizontal).apply { max = 100 }
        ...
        flow.webChromeClient = object : android.webkit.WebChromeClient() {
            override fun onProgressChanged(view: android.webkit.WebView?, progress: Int) {
                ...
                if (progress > 0) flowLoading.text = "Opening secure page... $progress%"
            }
        ...
        content.addView(flowProgress, FrameLayout.LayoutParams(-1, dp(3), Gravity.TOP))
    ...
    override fun onBackPressed() {
        if (flowWebView != null) {
            ...
            listener?.onPaymentTerminate(com.glomopay.sdk.TerminationSource.BACK_BUTTON)
            finishWith(GlomoPayResult.Cancelled)
        }
    }
    ...
    public companion object {
        public const val EXTRA_PUBLIC_KEY: String = "com.glomopay.sdk.PUBLIC_KEY"
        public const val EXTRA_ORDER_ID: String = "com.glomopay.sdk.ORDER_ID"
        public const val EXTRA_SUBSCRIPTION_ID: String = "com.glomopay.sdk.SUBSCRIPTION_ID"
        public const val EXTRA_SERVER: String = "com.glomopay.sdk.SERVER"
        public const val EXTRA_DEV_MODE: String = "com.glomopay.sdk.DEV_MODE"
        public const val EXTRA_ORDER_TYPE: String = "com.glomopay.sdk.ORDER_TYPE"
        public const val EXTRA_SESSION_ID: String = "com.glomopay.sdk.SESSION_ID"
